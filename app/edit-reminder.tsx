                        ...
                        <View style={styles.deactivateSection}>
                            ...
                            >
                                {deactivating ? (
                                    ...
                                    <>
                                        <Ionicons name="archive-outline" size={17} color={T.error} />
...
const styles = StyleSheet.create({
    ...
    backText: { fontSize: 16, fontWeight: '600', color: T.primary, marginLeft: 2 },
    ...
    labelOptional: { fontWeight: '500', color: T.textMuted },
    input: {
        backgroundColor: T.bgAlt,
        borderRadius: RADIUS.lg,
    ...
    inputFocused: { backgroundColor: T.bgSurface, borderColor: T.borderFocus },
